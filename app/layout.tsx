...
export const metadata: Metadata = {
  title: "Abhishek | MERN Stack Web Developer & React.js Specialist",
  description:
    "Explore Abhishek's portfolio featuring projects built with React.js, Node.js, and Tailwind CSS. MERN stack developer available for freelance and full-time opportunities.",
  keywords: [
    "Abhishek",
  ...
  openGraph: {
    title: "Abhishek | MERN Stack Web Developer",
    description:
      "Portfolio of Abhishek, showcasing React.js, Node.js, and MERN stack projects. Contact for freelance or full-time web development roles.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Abhishek Portfolio Preview",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Abhishek | MERN Stack Web Developer",
    description:
      "Check out Abhishek's React.js and Node.js projects. MERN stack developer open for freelance work and full-time roles.",
